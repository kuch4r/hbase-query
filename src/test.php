...
require_once('Core/QueryTable.php');
...
use kuchar\HbaseQuery\Core\QueryTable;
...
class HbaseFacebookPostsTable extends QueryTable {
    ...
    public function test() {
        return $this->query('queryBasic', array());
    }
}

$tt = new HbaseFacebookPostsTable();
$col = $tt->test();
